...
const logger = new Logger('CacheAgentMain');

/**
 * Simple EventBus implementation for the Cache Agent
 */
...
async function main() {
  try {
    ...
    logger.info('✓ Cache Agent started successfully');
    ...
    logger.error('Failed to start Cache Agent', error);
    process.exit(1);
  }
}
